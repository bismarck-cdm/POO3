    ...
    <div class="container-fluid">
        ...
        <form name="form-turma" method="POST" action="?paginas=turmas&acao=salvar">
                ...
                foreach ($turmas as $turma) {
                    ...
                    <td>
                        ...
                        <span class='badge rounded-pill bg-danger'>
                            <a href='?paginas=turmas&acao=excluir&codigo={$turma->getCodigo()}'style='color:#fff'><i class='bi bi-trash'></i></a>
                        </span>
                    </td>
                    </tr>";
                }
